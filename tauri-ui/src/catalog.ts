...
export const NODE_CATALOG: NodeTemplate[] = [
    ...
    {
        name: "Square Wave", category: "Oscillators", icon: "SQR", color: "#d4976c", numInputs: 0, numOutputs: 1, engineType: "Oscillator", engineSubtype: 0, params: [
            { name: "Frequency", hash: 0x811C9DC5, min: 20, max: 20000, default: 440, log: true, suffix: "Hz" },
            { name: "Duty Cycle", hash: 0xA1, min: 0.01, max: 0.99, default: 0.5, log: false, suffix: "" },
        ]
    },
    {
        name: "Sawtooth Wave", category: "Oscillators", icon: "SAW", color: "#d4976c", numInputs: 0, numOutputs: 1, engineType: "Oscillator", engineSubtype: 0, params: [
            { name: "Frequency", hash: 0x811C9DC5, min: 20, max: 20000, default: 440, log: true, suffix: "Hz" },
        ]
    },
    {
        name: "Triangle Wave", category: "Oscillators", icon: "TRI", color: "#d4976c", numInputs: 0, numOutputs: 1, engineType: "Oscillator", engineSubtype: 0, params: [
            { name: "Frequency", hash: 0x811C9DC5, min: 20, max: 20000, default: 440, log: true, suffix: "Hz" },
        ]
    },
    {
        name: "Pulse Wave", category: "Oscillators", icon: "PLS", color: "#d4976c", numInputs: 0, numOutputs: 1, engineType: "Oscillator", engineSubtype: 0, params: [
            { name: "Frequency", hash: 0x811C9DC5, min: 20, max: 20000, default: 440, log: true, suffix: "Hz" },
            { name: "Width", hash: 0xA2, min: 0.01, max: 0.99, default: 0.5, log: false, suffix: "" },
        ]
    },
    {
        name: "White Noise", category: "Oscillators", icon: "WN", color: "#d4976c", numInputs: 0, numOutputs: 1, engineType: "Oscillator", engineSubtype: 0, params: [
            { name: "Amplitude", hash: 0x811C9DC5, min: 0, max: 1, default: 0.5, log: false, suffix: "" },
        ]
    },
    {
        name: "Pink Noise", category: "Oscillators", icon: "PN", color: "#d4976c", numInputs: 0, numOutputs: 1, engineType: "Oscillator", engineSubtype: 0, params: [
            { name: "Amplitude", hash: 0x811C9DC5, min: 0, max: 1, default: 0.5, log: false, suffix: "" },
        ]
    },
    {
        name: "Brown Noise", category: "Oscillators", icon: "BN", color: "#d4976c", numInputs: 0, numOutputs: 1, engineType: "Oscillator", engineSubtype: 0, params: [
            { name: "Amplitude", hash: 0x811C9DC5, min: 0, max: 1, default: 0.5, log: false, suffix: "" },
        ]
    },
    {
        name: "FM Oscillator", category: "Oscillators", icon: "FM", color: "#d4976c", numInputs: 0, numOutputs: 1, engineType: "Oscillator", engineSubtype: 0, params: [
    ...
    {
        name: "AM Oscillator", category: "Oscillators", icon: "AM", color: "#d4976c", numInputs: 0, numOutputs: 1, engineType: "Oscillator", engineSubtype: 0, params: [
            { name: "Carrier", hash: 0x811C9DC5, min: 20, max: 20000, default: 440, log: true, suffix: "Hz" },
    ...
    {
        name: "Wavetable", category: "Oscillators", icon: "WT", color: "#d4976c", numInputs: 0, numOutputs: 1, engineType: "Oscillator", engineSubtype: 0, params: [
            { name: "Frequency", hash: 0x811C9DC5, min: 20, max: 20000, default: 440, log: true, suffix: "Hz" },
            { name: "Position", hash: 0xA7, min: 0, max: 1, default: 0, log: false, suffix: "" },
        ]
    },
    {
        name: "Sub Oscillator", category: "Oscillators", icon: "SUB", color: "#d4976c", numInputs: 0, numOutputs: 1, engineType: "Oscillator", engineSubtype: 0, params: [
    ...
    {
        name: "Super Saw", category: "Oscillators", icon: "SS", color: "#d4976c", numInputs: 0, numOutputs: 1, engineType: "Oscillator", engineSubtype: 0, params: [
            { name: "Frequency", hash: 0x811C9DC5, min: 20, max: 20000, default: 440, log: true, suffix: "Hz" },
    ...
    {
        name: "Additive Synth", category: "Oscillators", icon: "ADD", color: "#d4976c", numInputs: 0, numOutputs: 1, engineType: "Oscillator", engineSubtype: 0, params: [
    ...
    // -- Filters (18) ---
    {
        name: "Low-Pass Filter", category: "Filters", icon: "LPF", color: "#73c990", numInputs: 1, numOutputs: 1, engineType: "Filter", engineSubtype: 1, params: [
    ...
    {
        name: "Band-Pass Filter", category: "Filters", icon: "BPF", color: "#73c990", numInputs: 1, numOutputs: 1, engineType: "Filter", engineSubtype: 1, params: [
    ...
    {
        name: "Notch Filter", category: "Filters", icon: "NTC", color: "#73c990", numInputs: 1, numOutputs: 1, engineType: "Filter", engineSubtype: 1, params: [
            { name: "Center", hash: 0x811C9DC5, min: 20, max: 20000, default: 1000, log: true, suffix: "Hz" },
            { name: "Width", hash: 0x050C5D2E, min: 0.1, max: 12, default: 1, log: false, suffix: "" },
        ]
    },
    {
        name: "All-Pass Filter", category: "Filters", icon: "APF", color: "#73c990", numInputs: 1, numOutputs: 1, engineType: "Filter", engineSubtype: 1, params: [
            { name: "Cutoff", hash: 0x811C9DC5, min: 20, max: 20000, default: 1000, log: true, suffix: "Hz" },
        ]
    },
    {
        name: "Comb Filter", category: "Filters", icon: "CMB", color: "#73c990", numInputs: 1, numOutputs: 1, engineType: "Filter", engineSubtype: 1, params: [
    ...
    {
        name: "Formant Filter", category: "Filters", icon: "FMT", color: "#73c990", numInputs: 1, numOutputs: 1, engineType: "Filter", engineSubtype: 1, params: [
    ...
    {
        name: "Moog Ladder", category: "Filters", icon: "MOG", color: "#73c990", numInputs: 1, numOutputs: 1, engineType: "Filter", engineSubtype: 1, params: [
    ...
    {
        name: "State Variable", category: "Filters", icon: "SVF", color: "#73c990", numInputs: 1, numOutputs: 1, engineType: "Filter", engineSubtype: 1, params: [
    ...
    {
        name: "Parametric EQ", category: "Filters", icon: "PEQ", color: "#73c990", numInputs: 1, numOutputs: 1, engineType: "Filter", engineSubtype: 1, params: [
    ...
    {
        name: "Low Shelf EQ", category: "Filters", icon: "LSH", color: "#73c990", numInputs: 1, numOutputs: 1, engineType: "Filter", engineSubtype: 1, params: [
            { name: "Frequency", hash: 0x811C9DC5, min: 20, max: 5000, default: 200, log: true, suffix: "Hz" },
            { name: "Gain dB", hash: 0x050C5D2E, min: -18, max: 18, default: 0, log: false, suffix: "dB" },
        ]
    },
    {
        name: "High Shelf EQ", category: "Filters", icon: "HSH", color: "#73c990", numInputs: 1, numOutputs: 1, engineType: "Filter", engineSubtype: 1, params: [
            { name: "Frequency", hash: 0x811C9DC5, min: 1000, max: 20000, default: 8000, log: true, suffix: "Hz" },
            { name: "Gain dB", hash: 0x050C5D2E, min: -18, max: 18, default: 0, log: false, suffix: "dB" },
        ]
    },
    {
        name: "Tilt EQ", category: "Filters", icon: "TLT", color: "#73c990", numInputs: 1, numOutputs: 1, engineType: "Filter", engineSubtype: 1, params: [
    ...
    {
        name: "DC Blocker", category: "Filters", icon: "DCB", color: "#73c990", numInputs: 1, numOutputs: 1, engineType: "Filter", engineSubtype: 1, params: [
            { name: "Cutoff", hash: 0x811C9DC5, min: 5, max: 80, default: 20, log: false, suffix: "Hz" },
        ]
    },
    {
        name: "Moving Average", category: "Filters", icon: "MVA", color: "#73c990", numInputs: 1, numOutputs: 1, engineType: "Filter", engineSubtype: 1, params: [
            { name: "Window", hash: 0xB8, min: 1, max: 128, default: 8, log: false, suffix: "samp" },
        ]
    },
    {
        name: "Crossover", category: "Filters", icon: "XOV", color: "#73c990", numInputs: 1, numOutputs: 2, engineType: "Filter", engineSubtype: 1, params: [
    ...
    {
        name: "Resonator", category: "Filters", icon: "RES", color: "#73c990", numInputs: 1, numOutputs: 1, engineType: "Filter", engineSubtype: 1, params: [
    ...
    {
        name: "Vowel Filter", category: "Filters", icon: "VWL", color: "#73c990", numInputs: 1, numOutputs: 1, engineType: "Filter", engineSubtype: 1, params: [
    ...
    // -- Dynamics (7) ---
    {
        name: "Gain", category: "Dynamics", icon: "GN", color: "#6eb3f7", numInputs: 1, numOutputs: 1, engineType: "Gain", engineSubtype: 2, params: [
            { name: "Level", hash: 0x811C9DC5, min: 0, max: 2, default: 1, log: false, suffix: "" },
        ]
    },
    {
        name: "Attenuator", category: "Dynamics", icon: "ATT", color: "#6eb3f7", numInputs: 1, numOutputs: 1, engineType: "Gain", engineSubtype: 2, params: [
            { name: "Amount", hash: 0x811C9DC5, min: 0, max: 1, default: 0.5, log: false, suffix: "" },
        ]
    },
    {
        name: "VCA", category: "Dynamics", icon: "VCA", color: "#6eb3f7", numInputs: 1, numOutputs: 1, engineType: "Gain", engineSubtype: 2, params: [
            { name: "Level", hash: 0x811C9DC5, min: 0, max: 2, default: 1, log: false, suffix: "" },
        ]
    },
    {
        name: "Compressor", category: "Dynamics", icon: "CMP", color: "#6eb3f7", numInputs: 1, numOutputs: 1, engineType: "Gain", engineSubtype: 2, params: [
    ...
    {
        name: "Gate", category: "Dynamics", icon: "GAT", color: "#6eb3f7", numInputs: 1, numOutputs: 1, engineType: "Gain", engineSubtype: 2, params: [
    ...
    {
        name: "Expander", category: "Dynamics", icon: "EXP", color: "#6eb3f7", numInputs: 1, numOutputs: 1, engineType: "Gain", engineSubtype: 2, params: [
    ...
    // -- Effects (14) ---
    {
        name: "Delay", category: "Effects", icon: "DLY", color: "#c485ec", numInputs: 1, numOutputs: 1, engineType: "Filter", engineSubtype: 1, params: [
    ...
    {
        name: "Reverb", category: "Effects", icon: "RVB", color: "#c485ec", numInputs: 1, numOutputs: 1, engineType: "Filter", engineSubtype: 1, params: [
    ...
    {
        name: "Chorus", category: "Effects", icon: "CHO", color: "#c485ec", numInputs: 1, numOutputs: 1, engineType: "Filter", engineSubtype: 1, params: [
    ...
    {
        name: "Flanger", category: "Effects", icon: "FLG", color: "#c485ec", numInputs: 1, numOutputs: 1, engineType: "Filter", engineSubtype: 1, params: [
    ...
    {
        name: "Phaser", category: "Effects", icon: "PHS", color: "#c485ec", numInputs: 1, numOutputs: 1, engineType: "Filter", engineSubtype: 1, params: [
    ...
    {
        name: "Distortion", category: "Effects", icon: "DST", color: "#c485ec", numInputs: 1, numOutputs: 1, engineType: "Gain", engineSubtype: 2, params: [
    ...
    {
        name: "Overdrive", category: "Effects", icon: "OVD", color: "#c485ec", numInputs: 1, numOutputs: 1, engineType: "Gain", engineSubtype: 2, params: [
            { name: "Drive", hash: 0xE4, min: 0, max: 10, default: 2, log: false, suffix: "" },
            { name: "Tone", hash: 0xE5, min: 0, max: 1, default: 0.6, log: false, suffix: "" },
        ]
    },
    {
        name: "Bitcrusher", category: "Effects", icon: "BIT", color: "#c485ec", numInputs: 1, numOutputs: 1, engineType: "Gain", engineSubtype: 2, params: [
    ...
    {
        name: "Ring Modulator", category: "Effects", icon: "RNG", color: "#c485ec", numInputs: 1, numOutputs: 1, engineType: "Gain", engineSubtype: 2, params: [
    ...
    {
        name: "Tremolo", category: "Effects", icon: "TRM", color: "#c485ec", numInputs: 1, numOutputs: 1, engineType: "Gain", engineSubtype: 2, params: [
    ...
    {
        name: "Vibrato", category: "Effects", icon: "VIB", color: "#c485ec", numInputs: 1, numOutputs: 1, engineType: "Filter", engineSubtype: 1, params: [
    ...
    {
        name: "Waveshaper", category: "Effects", icon: "WS", color: "#c485ec", numInputs: 1, numOutputs: 1, engineType: "Gain", engineSubtype: 2, params: [
    ...
    {
        name: "Pitch Shifter", category: "Effects", icon: "PIT", color: "#c485ec", numInputs: 1, numOutputs: 1, engineType: "Filter", engineSubtype: 1, params: [
    ...
    {
        name: "Stereo Widener", category: "Effects", icon: "STW", color: "#c485ec", numInputs: 1, numOutputs: 1, engineType: "Gain", engineSubtype: 2, params: [
    ...
    {
        name: "LFO Square", category: "Modulators", icon: "LFQ", color: "#e8b75a", numInputs: 0, numOutputs: 1, engineType: "Oscillator", engineSubtype: 0, params: [
            { name: "Rate", hash: 0x811C9DC5, min: 0.01, max: 50, default: 1, log: true, suffix: "Hz" },
            { name: "Depth", hash: 0x11, min: 0, max: 1, default: 1, log: false, suffix: "" },
        ]
    },
    {
        name: "LFO Triangle", category: "Modulators", icon: "LFT", color: "#e8b75a", numInputs: 0, numOutputs: 1, engineType: "Oscillator", engineSubtype: 0, params: [
            { name: "Rate", hash: 0x811C9DC5, min: 0.01, max: 50, default: 1, log: true, suffix: "Hz" },
            { name: "Depth", hash: 0x12, min: 0, max: 1, default: 1, log: false, suffix: "" },
        ]
    },
    {
        name: "LFO Sample & Hold", category: "Modulators", icon: "S+H", color: "#e8b75a", numInputs: 0, numOutputs: 1, engineType: "Oscillator", engineSubtype: 0, params: [
    ...
    // -- Utility (7) ---
    {
        name: "Mixer 2-Ch", category: "Utility", icon: "MIX", color: "#a0a4ab", numInputs: 2, numOutputs: 1, engineType: "Gain", engineSubtype: 2, params: [
            { name: "Ch A", hash: 0x20, min: 0, max: 2, default: 1, log: false, suffix: "" },
            { name: "Ch B", hash: 0x21, min: 0, max: 2, default: 1, log: false, suffix: "" },
        ]
    },
    {
        name: "Crossfade", category: "Utility", icon: "XFD", color: "#a0a4ab", numInputs: 2, numOutputs: 1, engineType: "Gain", engineSubtype: 2, params: [
    ...
    {
        name: "DC Offset", category: "Utility", icon: "DCO", color: "#a0a4ab", numInputs: 1, numOutputs: 1, engineType: "Gain", engineSubtype: 2, params: [
            { name: "Offset", hash: 0x23, min: -1, max: 1, default: 0, log: false, suffix: "" },
        ]
    },
    { name: "Inverter", category: "Utility", icon: "INV", color: "#a0a4ab", numInputs: 1, numOutputs: 1, engineType: "Gain", engineSubtype: 2, params: [] },
    { name: "Splitter", category: "Utility", icon: "SPL", color: "#a0a4ab", numInputs: 1, numOutputs: 2, engineType: "Gain", engineSubtype: 2, params: [] },

    // -- Output (1) ---
    { name: "Speaker Output", category: "Output", icon: "OUT", color: "#c8c8c8", numInputs: 1, numOutputs: 0, engineType: "Output", engineSubtype: 3, params: [] },
];
